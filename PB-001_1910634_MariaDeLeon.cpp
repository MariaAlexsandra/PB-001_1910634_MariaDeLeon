...
//*SELECCIÓN 1*//
	...
	//NOMBRE: se pide el nombre al usuario:
					...
					cin.getline(nombre, 50, '\n'); /*funcion que permite la entrada de cadena de caracteres:primero la variable que se leerá, 
									la cantidad limitada de caracteres permitidos y que terminará cuando el usuario ingrese un enter*/
